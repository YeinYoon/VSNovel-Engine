...
<div v-if="cModalState">
  ...
  <div v-bind:class="{[`Cmodal_frame_${this.cModalSize}`]:true}">
    ...
    <div class="Cmodal_save_button" @click="modalCloseY()">
      <span class="Cmodal_save_ok">{{this.cModalBtn1}}</span>
    </div>
    <div class="Cmodal_cancel_button" @click="modalCloseN()">
      <span class="Cmodal_cancel_ok">{{this.cModalBtn2}}</span>
    </div>
  </div>  
</div>
</template>
